...
public class MovieVO {
    ...
    //cover_from    varchar(128)   封面图片地址
    private String coverFrom;
    //category      varchar(16)    类别--日，欧美，国产
    ...
    public MovieSrc getMovieSrc() {
        return movieSrc;
    }

    public void setMovieSrc(MovieSrc movieSrc) {
